...
;(function($) {
        ...
        function startTimeliner(options) {
            var settings = {
                ...
                timelineSection: options['timelineSection'] || '.timeline-wrapper1',
                ...
                timelineTriggerContainer: options['timelineTriggerContainer'] || '.timeline-series1',
                // Wrapper surrounding a series of events corresponding to the timelineSectionMarker
                // value: selector
                // default: .timeline-series
                // note: changing this selector from the default will require modifications to the CSS file in order to retain default styling

                timelineTriggerAnchor: options['timelineTriggerAnchor'] || '.timeline-event1',
                ...
                timelineEXContent: options['timelineEXContent'] || '.timeline-event-content1',
                ...
                expandAllText: options ['expandAllText'] || '+ Hiển thị tất cả',
                // sets the text of the expandAll selector after the timeline is fully collapsed
                // value: string
                // default: + expand all

                collapseAllText: options['collapseAllText'] || '- Đóng tất cả'
            ...
            if ($(settings.timelineContainer).data('started')) {
                ...
                $(settings.timelineContainer+" "+".timeline-toggle1").html(settings.expandAllText);
                ...
                // All Markers/Events
                var el = settings.timelineContainer+" "+".timeline-toggle1";
                $(el).click(function()
                {

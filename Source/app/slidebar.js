					...
					<div className="sidebar-category sidebar-category-visible">
						<div className="category-content no-padding">
							<ul className="navigation navigation-main navigation-accordion">
								...
								<li id="Lichsu" >
									<a><i className="icon-history"></i> <span>Lịch sử</span></a>
									<ul>
										<li id="Lichsu_lop6">
											<a><span>Lớp 6</span></a>
											<ul> 
								...
								<li id="Hoidap">
									...
									<ul>
										<li id="Hoidap_lichsu"><a  href="#hoidap/lichsu">Lịch Sử</a></li>
										<li id="Hoidap_diali"><a href="#hoidap/diali" >Địa lí</a></li>
									</ul>
								</li>

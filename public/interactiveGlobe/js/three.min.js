...
THREE.Frustum.prototype.contains = function(a) {
    for (var b = 0, c = this.planes, b = a.matrixWorld, d = b.elements, a = -a.geometry.boundingSphere.radius * b.getMaxScaleOnAxis(), e = 0; 6 > e; e++)
        if (b = c[e].x * d[12] + c[e].y * d[13] + c[e].z * d[14] + c[e].w, b <= a) return !1;
    return !0
};
    ...
    var b = new a.Vector3,
        ...
        o = function(i, l, j) {
            ...
            if (i instanceof a.Particle) {
                ...
                q = 0;
                for (A = y.faces.length; q < A; q++)
                    if (o = y.faces[q], m = !0 === H ? G[o.materialIndex] : i.material, void 0 !== m && (J = m.side, e.sub(o.centroid, c), f = o.normal, m = d.dot(f), !(Math.abs(m) < M) && (v = f.dot(e) / m, !(0 > v) && (J === a.DoubleSide ||
                            (J === a.FrontSide ? 0 > m : 0 < m)))))
                        if (g.add(c, d.multiplyScalar(v)), o instanceof a.Face3) m = C[o.a], v = C[o.b], J = C[o.c], p(g, m, v, J) && (v = i.matrixWorld.multiplyVector3(g.clone()), m = b.distanceTo(v), m < l.near || m > l.far || (o = {
                            distance: m,
                            point: v,
                            face: o,
                            faceIndex: q,
...
THREE.Projector = function() {
    ...
    this.projectScene = function(g, h, m, N) {
        ...
        g = 0;
        for (m = H.objects.length; g <
            m; g++)
            if (ca = H.objects[g].object, Ga = ca.matrixWorld, j = 0, ca instanceof THREE.Mesh) {
                Pa = ca.geometry;
                ...
                fa = 0;
                for (la = Ua.length; fa < la; fa++)
                    if (O = Ua[fa], Ra = !0 === ib ? Ia[O.materialIndex] : ca.material, void 0 !== Ra) {
                        ia = Ra.side;
                        if (O instanceof THREE.Face3)
                            if (W = l[O.a], V = l[O.b], Z = l[O.c], !0 === W.visible && !0 === V.visible && !0 === Z.visible)
                                if (qa = 0 > (Z.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (Z.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide)) p === q ? (na = new THREE.RenderableFace3,
                                    o.push(na), q++, p++, n = na) : n = o[p++], n.v1.copy(W), n.v2.copy(V), n.v3.copy(Z);
                                else continue;
                        else continue;
                        else if (O instanceof THREE.Face4)
                            if (W = l[O.a], V = l[O.b], Z = l[O.c], na = l[O.d], !0 === W.visible && !0 === V.visible && !0 === Z.visible && !0 === na.visible)
                                if (qa = 0 > (na.positionScreen.x - W.positionScreen.x) * (V.positionScreen.y - W.positionScreen.y) - (na.positionScreen.y - W.positionScreen.y) * (V.positionScreen.x - W.positionScreen.x) || 0 > (V.positionScreen.x - Z.positionScreen.x) * (na.positionScreen.y - Z.positionScreen.y) - (V.positionScreen.y -
                                        Z.positionScreen.y) * (na.positionScreen.x - Z.positionScreen.x), ia === THREE.DoubleSide || qa === (ia === THREE.FrontSide)) {
                                    if (r === B) {
                        ...
                        W = 0;
                        for (V = Va.length; W < V; W++)
                            if (na = Va[W][fa], void 0 !== na) {
                                ia = 0;
        ...
        for (m = H.sprites.length; g < m; g++) ca = H.sprites[g].object, Ga = ca.matrixWorld, ca instanceof THREE.Particle && (E.set(Ga.elements[12], Ga.elements[13], Ga.elements[14], 1), M.multiplyVector4(E), E.z /= E.w, 0 < E.z && 1 > E.z && (y === G ? (ea = new THREE.RenderableParticle, C.push(ea), G++, y++, v = ea) : v = C[y++], v.object = ca, v.x = E.x / E.w, v.y = E.y / E.w, v.z = E.z, v.rotation = ca.rotation.z, v.scale.x = ca.scale.x * Math.abs(v.x - (E.x + h.projectionMatrix.elements[0]) / (E.w + h.projectionMatrix.elements[12])), v.scale.y = ca.scale.y *
            Math.abs(v.y - (E.y + h.projectionMatrix.elements[5]) / (E.w + h.projectionMatrix.elements[13])), v.material = ca.material, H.elements.push(v)));
...
THREE.Geometry = function() {
    ...
    this.hasTangents = !1;
    this.dynamic = !0;
    this.colorsNeedUpdate = this.tangentsNeedUpdate = this.normalsNeedUpdate = this.uvsNeedUpdate = this.elementsNeedUpdate =
...
THREE.Geometry.prototype = {
    ...
    computeTangents: function() {
        ...
        for (c = this.faces.length; b < c; b++) {
            f = this.faces[b];
            for (d = 0; d < f.vertexNormals.length; d++) K.copy(f.vertexNormals[d]), e = f[F[d]], y = C[e], E.copy(y), E.subSelf(K.multiplyScalar(K.dot(y))).normalize(), M.cross(f.vertexNormals[d], y), e = M.dot(G[e]), e = 0 > e ?
    ...
    computeBoundingBox: function() {
        ...
        if (0 < this.vertices.length) {
            ...
            for (var b = this.boundingBox.min, c = this.boundingBox.max, d = 1, e = this.vertices.length; d < e; d++)(a = this.vertices[d], a.x < b.x ? b.x = a.x : a.x > c.x && (c.x = a.x), a.y < b.y ? b.y = a.y : a.y > c.y && (c.y = a.y), a.z < b.z) ? b.z = a.z : a.z >
                c.z && (c.z = a.z)
    ...
    mergeVertices: function() {
        ...
        for (g = this.faces.length; f < g; f++)
            if (a = this.faces[f], a instanceof THREE.Face3) a.a = c[a.a], a.b = c[a.b], a.c = c[a.c];
            ...
            for (e = 3; 0 < e; e--)
                if (d.indexOf(a["abcd" [e]]) !== e) {
                    ...
                    d = 0;
                    for (h = this.faceVertexUvs.length; d < h; d++)(i = this.faceVertexUvs[d][f]) &&
                        i.splice(e, 1);
...
THREE.BufferGeometry.prototype = {
    ...
    computeBoundingBox: function() {
        ...
        if (a)
            for (var b = this.boundingBox, c, d, e, f = 0, g = a.length; f < g; f += 3)(c = a[f], d = a[f + 1], e = a[f + 2], c < b.min.x ? b.min.x = c : c > b.max.x && (b.max.x = c), d < b.min.y ? b.min.y = d : d > b.max.y && (b.max.y = d), e < b.min.z) ? b.min.z = e : e > b.max.z && (b.max.z = e);
    ...
    computeVertexNormals: function() {
        if (this.attributes.position && this.attributes.index) {
            ...
            for (d = e.length; c < d; ++c) {
                ...
                var u = e[c].index;
                a = b;
                for (b += i; a < b; a += 3) i = u + f[a], j = u + f[a + 1], l = u + f[a + 2], m = g[3 * i], n = g[3 * i + 1], p = g[3 * i + 2], o.set(m, n, p), m = g[3 * j], n = g[3 * j + 1], p = g[3 * j + 2], q.set(m, n, p), m = g[3 * l], n = g[3 * l + 1], p = g[3 * l + 2], r.set(m, n, p), t.sub(r, q), B.sub(o, q), t.crossSelf(B), h[3 * i] += t.x, h[3 * i + 1] += t.y, h[3 * i +
    ...
    computeTangents: function() {
        ...
        if (void 0 === this.attributes.index ||
            void 0 === this.attributes.position || void 0 === this.attributes.normal || void 0 === this.attributes.uv) console.warn("Missing required attributes (index, position, normal or uv) in BufferGeometry.computeTangents()");
        else {
            ...
            for (J = F.length; H < J; ++H) {
                ...
                var I = F[H].index;
                C = G;
                for (G += E; C < G; C += 3) E = I + b[C], M = I + b[C + 1], K = I + b[C + 2], l = c[3 * E], m = c[3 * E + 1], n = c[3 * E + 2], p = c[3 * M], o = c[3 * M + 1], q = c[3 * M + 2], r = c[3 * K], t = c[3 * K + 1], B = c[3 * K + 2], u = e[2 * E], s = e[2 * E + 1], z = e[2 * M], A = e[2 * M + 1], v = e[2 * K], y = e[2 * K + 1], p -= l, l = r - l, o -= m, m = t - m, q -= n, n = B - n, z -= u, u = v - u, A -= s, s = y -
...
THREE.JSONLoader.prototype.createModel = function(a, b, c) {
    ...
    for (i = u.length; c < i;) {
        ...
        h = d.faces.length;
        if (f)
            for (f = 0; f < A; f++) r = a.uvs[f], n = u[c++], B = r[2 * n], n = r[2 * n + 1], d.faceUvs[f][h] = new THREE.UV(B, n);
        if (g)
            for (f = 0; f < A; f++) {
                r = a.uvs[f];
                t = [];
        ...
        if (l)
            for (f =
                0; f < j; f++) m = 3 * u[c++], g = new THREE.Vector3, g.x = s[m++], g.y = s[m++], g.z = s[m], q.vertexNormals.push(g);
        o && (l = u[c++], l = new THREE.Color(z[l]), q.color = l);
        if (p)
            for (f = 0; f < j; f++) l = u[c++], l = new THREE.Color(z[l]), q.vertexColors.push(l);
        d.faces.push(q)
    }
    if (a.skinWeights) {
        c = 0;
...
THREE.GeometryLoader.prototype = {
    ...
    parse: function(a, b) {
        ...
        for (p = g.length; m < p;) {
            ...
            if (o)
                for (f = 0; f < z; f++) u = 3 * g[m++], t = new THREE.Vector3, t.x = n[u++], t.y = n[u++], t.z = n[u], r.vertexNormals.push(t);
            s && (o = g[m++], r.color = new THREE.Color(j[o]));
            if (q)
                for (f = 0; f < z; f++) o =
                    g[m++], r.vertexColors.push(new THREE.Color(j[o]));
            d.faces.push(r)
        }
        if (a.skinWeights) {
            f = 0;
...
THREE.SceneLoader.prototype.parse = function(a, b, c) {
            ...
            if (void 0 === I.objects[c]) {
                ...
                if (f) {
                    if (void 0 !== d.properties)
                        for (var g in d.properties) f.properties[g] =
                            d.properties[g];
    ...
    for (A in this.geometryHandlerMap) this.geometryHandlerMap[A].loaderObject =
        new this.geometryHandlerMap[A].loaderClass;
    M = E = 0;
    I = {
    ...
    K = E;
    for (l in L.geometries)
        if (o = L.geometries[l], "cube" === o.type) y = new THREE.CubeGeometry(o.width, o.height, o.depth, o.segmentsWidth, o.segmentsHeight, o.segmentsDepth, null, o.flipped, o.sides), I.geometries[l] = y;
        else if ("plane" === o.type) y =
        new THREE.PlaneGeometry(o.width, o.height, o.segmentsWidth, o.segmentsHeight), I.geometries[l] = y;
    ...
    for (q in L.textures)
        if (l = L.textures[q], l.url instanceof Array) {
            M += l.url.length;
    ...
    for (q in L.textures) {
        ...
        if (l.url instanceof Array) {
            ...
            if (l.wrap && (o = {
                    repeat: THREE.RepeatWrapping,
                    mirror: THREE.MirroredRepeatWrapping
                }, void 0 !== o[l.wrap[0]] && (J.wrapS = o[l.wrap[0]]), void 0 !== o[l.wrap[1]])) J.wrapT =
                o[l.wrap[1]]
        }
        I.textures[q] = J
    }
    for (m in L.materials) {
        ...
        r.parameters.normalMap ? (q = THREE.ShaderUtils.lib.normal, a = THREE.UniformsUtils.clone(q.uniforms), l =
            ...
            (a.uOpacity.value = r.parameters.opacity), C = new THREE.ShaderMaterial({
...
THREE.MorphAnimMesh.prototype.updateAnimation = function(a) {
    ...
    if (this.mirroredLoop) {
        if (this.time > this.duration || 0 > this.time)
            if (this.direction *= -1, this.time > this.duration && (this.time = this.duration, this.directionBackwards = !0), 0 > this.time) this.time = 0, this.directionBackwards = !1
...
THREE.CanvasRenderer = function(a) {
    ...
    var a = a || {},
        ...
        Ga = {},
        Pa = {},
        Ia, Ua, na, Va, ib, Ra, eb, pb, Pb, db, $a = new THREE.Rectangle,
        ...
        if (!1 === l instanceof THREE.Camera) console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            if (!0 === wb) {
                ...
                for (Fc = i.length; B < Fc; B++) {
                    aa = i[B];
                    var z = aa.color;
                    aa instanceof THREE.AmbientLight ? (Da.r += z.r, Da.g += z.g, Da.b += z.b) : aa instanceof THREE.DirectionalLight ? (qb.r += z.r, qb.g += z.g, qb.b += z.b) : aa instanceof THREE.PointLight &&
                        (fb.r += z.r, fb.g += z.g, fb.b += z.b)
                }
            }
            B = 0;
            for (Fc = h.length; B < Fc; B++)
                if (ja = h[B], aa = ja.material, !(void 0 === aa || !1 === aa.visible)) {
                    wa.empty();
                    if (ja instanceof THREE.RenderableParticle) {
                        ...
                        o, !0 === aa.overdraw && (Wb(C.positionScreen, G.positionScreen), Wb(G.positionScreen, H.positionScreen), Wb(H.positionScreen, C.positionScreen)), wa.add3Points(C.positionScreen.x, C.positionScreen.y, G.positionScreen.x, G.positionScreen.y, H.positionScreen.x, H.positionScreen.y), !0 === $a.intersects(wa) && n(C, G, H, 0, 1, 2, ja, aa, a);
                    else if (ja instanceof THREE.RenderableFace4 && (C = ja.v1, G = ja.v2, H = ja.v3, J = ja.v4, C.positionScreen.x *= p, C.positionScreen.y *= o, G.positionScreen.x *= p, G.positionScreen.y *= o, H.positionScreen.x *= p, H.positionScreen.y *=
...
THREE.ShaderLib = {
    ...
    basic: {
        ...
        vertexShader: [THREE.ShaderChunk.map_pars_vertex,
            ...
            "#endif", THREE.ShaderChunk.morphtarget_vertex, THREE.ShaderChunk.skinning_vertex, THREE.ShaderChunk.default_vertex, THREE.ShaderChunk.worldpos_vertex, THREE.ShaderChunk.envmap_vertex, THREE.ShaderChunk.shadowmap_vertex, "}"
        ].join("\n"),
    ...
    phong: {
        ...
        vertexShader: ["#define PHONG\nvarying vec3 vViewPosition;\nvarying vec3 vNormal;",
            ...
            THREE.ShaderChunk.defaultnormal_vertex, "vNormal = transformedNormal;", THREE.ShaderChunk.morphtarget_vertex, THREE.ShaderChunk.skinning_vertex, THREE.ShaderChunk.default_vertex, "vViewPosition = -mvPosition.xyz;", THREE.ShaderChunk.worldpos_vertex, THREE.ShaderChunk.envmap_vertex, THREE.ShaderChunk.lights_phong_vertex, THREE.ShaderChunk.shadowmap_vertex, "}"
        ].join("\n"),
    ...
    depthRGBA: {
        ...
        vertexShader: [THREE.ShaderChunk.morphtarget_pars_vertex, THREE.ShaderChunk.skinning_pars_vertex, "void main() {",
            THREE.ShaderChunk.skinbase_vertex, THREE.ShaderChunk.morphtarget_vertex, THREE.ShaderChunk.skinning_vertex, THREE.ShaderChunk.default_vertex, "}"
        ].join("\n"),
...
THREE.WebGLRenderer = function(a) {
    ...
    function g(a, b, c) {
        ...
        if (c.sortParticles) {
            ...
            if (q) {
                ...
                for (j = q.length; i < j; i++)
                    ...
                    for (d = 0; d < e; d++) g = m[d][1], g = h.value[g], h.array[f] = g.x, h.array[f + 1] = g.y, f += 2;
                else if (3 === h.size)
                    if ("c" === h.type)
                        for (d = 0; d < e; d++) g =
                            m[d][1], g = h.value[g], h.array[f] = g.r, h.array[f + 1] = g.g, h.array[f + 2] = g.b, f += 3;
                    else
                        for (d = 0; d < e; d++) g = m[d][1], g = h.value[g], h.array[f] = g.x, h.array[f + 1] = g.y, h.array[f + 2] = g.z, f += 3;
                else if (4 === h.size)
                    for (d = 0; d < e; d++) g = m[d][1], g = h.value[g], h.array[f] = g.x, h.array[f + 1] = g.y, h.array[f + 2] = g.z, h.array[f + 3] = g.w, f += 4
            }
        } else {
            if (o)
                for (d = 0; d < g; d++) e = h[d], f = 3 * d, l[f] = e.x, l[f + 1] = e.y, l[f + 2] = e.z;
            if (p)
                for (d = 0; d < j; d++) e = i[d], f = 3 * d, n[f] = e.r, n[f + 1] = e.g, n[f + 2] = e.b;
            if (q) {
                i = 0;
                for (j = q.length; i < j; i++)
                    ...
                    for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.x, h.array[f + 1] = g.y, f += 2;
                else if (3 === h.size)
                    if ("c" === h.type)
                        for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.r, h.array[f + 1] = g.g, h.array[f + 2] = g.b, f += 3;
                    else
                        for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.x, h.array[f + 1] = g.y, h.array[f + 2] = g.z, f += 3;
                else if (4 === h.size)
                    for (d = 0; d < e; d++) g = h.value[d], h.array[f] = g.x, h.array[f + 1] = g.y, h.array[f + 2] = g.z, h.array[f +
                        3] = g.w, f += 4
            }
        }
        ...
        if (q) {
            i = 0;
            for (j = q.length; i < j; i++)
                if (h = q[i], h.needsUpdate || c.sortParticles) k.bindBuffer(k.ARRAY_BUFFER, h.buffer), k.bufferData(k.ARRAY_BUFFER, h.array, b)
        }
    }
    ...
    function h(a, b, c) {
        ...
        a.elementsNeedUpdate && void 0 !==
            f && (k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, f.buffer), k.bufferData(k.ELEMENT_ARRAY_BUFFER, f.array, b));
        ...
        if (c)
            for (var j in a.attributes) delete a.attributes[j].array
    }
    ...
    function l(a, b, c) {
        if (a.length)
            for (var d = 0, f = a.length; d < f; d++) ia = O = null, W = V = Pa = Ga = Ra = ib = Ia = -1, Ea = !0, a[d].render(b, c, Da, qb), ia = O = null, W = V = Pa = Ga = Ra = ib = Ia = -1, Ea = !0
    }

    function m(a, b, c, d, f, e, g, h) {
        var k, i, j, l;
        b ? (i = a.length - 1, l = b = -1) :
            (i = 0, b = a.length, l = 1);
        for (var n = i; n !== b; n += l)
            if (k = a[n], k.render) {
                i = k.object;
    ...
    function n(a, b, c, d, f, e, g) {
        for (var h, k, i = 0, j = a.length; i < j; i++)
            if (h = a[i], k =
                h.object, k.visible) {
                if (g) h = g;
                else {
    ...
    function B(a, b, c, d, f) {
        ...
        d.id !== W && (W = d.id, e = !0);
        if (e || a !==
            ia) k.uniformMatrix4fv(h.projectionMatrix, !1, a._projectionMatrixArray), a !== ia && (ia = a);
        if (d.skinning)
            if (ic && f.useVertexTexture) {
        ...
        if (e) {
            ...
            d instanceof THREE.LineBasicMaterial ? (i.diffuse.value = d.color, i.opacity.value = d.opacity) : d instanceof THREE.ParticleBasicMaterial ? (i.psColor.value = d.color, i.opacity.value = d.opacity, i.size.value = d.size, i.scale.value = M.height /
                ...
                (i.ambient.value = d.ambient, i.emissive.value = d.emissive), d.wrapAround && i.wrapRGB.value.copy(d.wrapRGB)) : d instanceof THREE.MeshDepthMaterial ? (i.mNear.value = a.near, i.mFar.value = a.far, i.opacity.value = d.opacity) : d instanceof THREE.MeshNormalMaterial && (i.opacity.value = d.opacity);
            if (f.receiveShadow && !d._shadowPass && i.shadowMatrix) {
                c = Y = 0;
                for (e = b.length; c < e; c++)
                    if (j = b[c], j.castShadow && (j instanceof THREE.SpotLight || j instanceof THREE.DirectionalLight && !j.shadowCascade)) i.shadowMap.value[Y] = j.shadowMap, i.shadowMapSize.value[Y] =
            ...
            for (Y = b.length; i < Y; i++)
                if (e = g.uniforms[b[i][1]])
                    if (c = b[i][0], l = c.type, j = c.value, "i" === l) k.uniform1i(e, j);
                ...
                void 0 ===
                    c._array && (c._array = new Float32Array(4 * j.length));
                l = 0;
                ...
                l) {
                if (m = j, j = u(), k.uniform1i(e, j), m)
                    if (m.image instanceof Array && 6 === m.image.length) {
                        if (c = m, e = j, 6 === c.image.length)
                            if (c.needsUpdate) {
    ...
    var a = a || {},
        ...
        ea =
        void 0 !== a.maxLights ? a.maxLights : 4;
    this.domElement = M;
    this.context = null;
    ...
    Qb = k.getExtension("EXT_texture_filter_anisotropic") ||
    ...
    this.deallocateObject = function(a) {
        if (a.__webglInit)
            if (a.__webglInit = !1, delete a._modelViewMatrix, delete a._normalMatrix, delete a._normalMatrixArray, delete a._modelViewMatrixArray, delete a._modelMatrixArray,
                ...
                for (var b in a.geometry.geometryGroups) {
                    ...
                    if (c.__webglCustomAttributesList)
                        for (d in d = void 0, c.__webglCustomAttributesList) k.deleteBuffer(c.__webglCustomAttributesList[d].buffer);
    ...
    this.deallocateRenderTarget = function(a) {
        if (a && a.__webglTexture)
            if (k.deleteTexture(a.__webglTexture),
    ...
    this.renderBufferImmediate = function(a, b, c) {
        ...
        if (a.hasNormals) {
            ...
            if (c.shading === THREE.FlatShading) {
                ...
                for (o = 0; o < p; o += 9) m = a.normalArray, d = m[o], e = m[o + 1], f = m[o + 2], g = m[o + 3], i = m[o + 4], l = m[o + 5], h = m[o + 6], j = m[o + 7], n = m[o + 8], d = (d + g + h) /
        ...
        a.hasColors &&
            c.vertexColors !== THREE.NoColors && (k.bindBuffer(k.ARRAY_BUFFER, a.__webglColorBuffer), k.bufferData(k.ARRAY_BUFFER, a.colorArray, k.DYNAMIC_DRAW), k.enableVertexAttribArray(b.attributes.color), k.vertexAttribPointer(b.attributes.color, 3, k.FLOAT, !1, 0, 0));
        k.drawArrays(k.TRIANGLES, 0, a.count);
        a.count = 0
    };
    this.renderBufferDirect = function(a, b, c, d, e, f) {
        if (!1 !== d.visible)
            if (c = B(a, b, c, d, f), a = c.attributes, b = !1, d = 16777215 * e.id + 2 * c.id + (d.wireframe ? 1 : 0), d !== V && (V = d, b = !0), f instanceof THREE.Mesh) {
                f = e.offsets;
                1 < f.length &&
                    (b = !0);
                d = 0;
        ...
        if (!1 !== d.visible) {
            ...
            if (a) {
                if (e.__webglCustomAttributesList) {
                    g = 0;
                    for (h = e.__webglCustomAttributesList.length; g < h; g++) c =
        ...
        if (!1 === b instanceof THREE.Camera) console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");
            ...
            for (e = h.length; d < e; d++)
                if (f = h[d], g = f.object, f.render = !1,
                    ...
                    f.render = !0;
                    !0 === this.sortObjects && (null !== g.renderDepth ? f.z = g.renderDepth :
    ...
    this.initWebGLObjects = function(a) {
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!i.__webglActive) {
                if (i instanceof THREE.Mesh)
                    if (m = i.geometry, m instanceof THREE.BufferGeometry) p(j.__webglObjects, m, i);
                    else
                        for (l in m.geometryGroups) n = m.geometryGroups[l], p(j.__webglObjects, n, i);
                else i instanceof THREE.Ribbon || i instanceof THREE.Line || i instanceof THREE.ParticleSystem ? (m = i.geometry, p(j.__webglObjects, m, i)) : i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback ?
        ...
        for (; a.__objectsRemoved.length;) {
            var lb = a.__objectsRemoved[0],
                Za = a;
            lb instanceof THREE.Mesh || lb instanceof THREE.ParticleSystem || lb instanceof THREE.Ribbon || lb instanceof THREE.Line ? r(Za.__webglObjects, lb) : lb instanceof THREE.Sprite ? t(Za.__webglSprites, lb) : lb instanceof THREE.LensFlare ?
                t(Za.__webglFlares, lb) : (lb instanceof THREE.ImmediateRenderObject || lb.immediateRenderCallback) && r(Za.__webglObjectsImmediate, lb);
            lb.__webglActive = !1;
        ...
        for (var fb = 0, qb = a.__webglObjects.length; fb < qb; fb++) {
            ...
            if (ub instanceof THREE.Mesh)
                if (ga instanceof THREE.BufferGeometry)(ga.verticesNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangentsNeedUpdate) &&
                    ...
                    for (var pb = 0, wb = ga.geometryGroupsList.length; pb < wb; pb++)
                        if (gb = ga.geometryGroupsList[pb], ab = c(ub, gb), eb = ab.attributes && o(ab), ga.verticesNeedUpdate || ga.morphTargetsNeedUpdate || ga.elementsNeedUpdate || ga.uvsNeedUpdate || ga.normalsNeedUpdate || ga.colorsNeedUpdate || ga.tangentsNeedUpdate || eb) {
                            var ma = gb,
                                xb = ub,
                                mb = k.DYNAMIC_DRAW,
                                yb = !ga.dynamic,
                            ...
                            if (ma.__inittedArrays) {
                                ...
                                if (bb.verticesNeedUpdate) {
                                    ...
                                    D = 0;
                                    for (X =
                                        pa.length; D < X; D++) P = Ta[pa[D]], S = ec[P.a], T = ec[P.b], U = ec[P.c], ka = ec[P.d], Na[Ha] = S.x, Na[Ha + 1] = S.y, Na[Ha + 2] = S.z, Na[Ha + 3] = T.x, Na[Ha + 4] = T.y, Na[Ha + 5] = T.z, Na[Ha + 6] = U.x, Na[Ha + 7] = U.y, Na[Ha + 8] = U.z, Na[Ha + 9] = ka.x, Na[Ha + 10] = ka.y, Na[Ha + 11] = ka.z, Ha += 12;
                                ...
                                if (id && Pb) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], vb = P.vertexColors, Hc = P.color, 3 === vb.length && Pb ===
                                        THREE.VertexColors ? (Fb = vb[0], Gb = vb[1], Hb = vb[2]) : Hb = Gb = Fb = Hc, Oa[Fa] = Fb.r, Oa[Fa + 1] = Fb.g, Oa[Fa + 2] = Fb.b, Oa[Fa + 3] = Gb.r, Oa[Fa + 4] = Gb.g, Oa[Fa + 5] = Gb.b, Oa[Fa + 6] = Hb.r, Oa[Fa + 7] = Hb.g, Oa[Fa + 8] = Hb.b, Fa += 9;
                                    D = 0;
                                ...
                                if (Tc && bb.hasTangents) {
                                    ...
                                    D = 0;
                                    for (X = pa.length; D < X; D++) P = Ta[pa[D]], Rb = P.vertexTangents, zb = Rb[0], Ab = Rb[1], Bb = Rb[2], sc = Rb[3], xa[ua] =
                                        zb.x, xa[ua + 1] = zb.y, xa[ua + 2] = zb.z, xa[ua + 3] = zb.w, xa[ua + 4] = Ab.x, xa[ua + 5] = Ab.y, xa[ua + 6] = Ab.z, xa[ua + 7] = Ab.w, xa[ua + 8] = Bb.x, xa[ua + 9] = Bb.y, xa[ua + 10] = Bb.z, xa[ua + 11] = Bb.w, xa[ua + 12] = sc.x, xa[ua + 13] = sc.y, xa[ua + 14] = sc.z, xa[ua + 15] = sc.w, ua += 16;
                                    k.bindBuffer(k.ARRAY_BUFFER, ma.__webglTangentBuffer);
                                    k.bufferData(k.ARRAY_BUFFER, xa, mb)
                                }
                                if (Sc && Qb) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++)
                                        if (P = Ta[oa[D]], lc = P.vertexNormals, Yb = P.normal, 3 === lc.length && Gc)
                                            for (sa = 0; 3 > sa; sa++) Zb = lc[sa], ob[Sa] = Zb.x, ob[Sa + 1] = Zb.y, ob[Sa + 2] = Zb.z, Sa += 3;
                                        else
                                            for (sa =
                                                0; 3 > sa; sa++) ob[Sa] = Yb.x, ob[Sa + 1] = Yb.y, ob[Sa + 2] = Yb.z, Sa += 3;
                                    D = 0;
                                    for (X = pa.length; D < X; D++)
                                        if (P = Ta[pa[D]], lc = P.vertexNormals, Yb = P.normal, 4 === lc.length && Gc)
                                            for (sa = 0; 4 > sa; sa++) Zb = lc[sa], ob[Sa] = Zb.x, ob[Sa + 1] = Zb.y, ob[Sa + 2] = Zb.z, Sa += 3;
                                        else
                                            for (sa = 0; 4 > sa; sa++) ob[Sa] = Yb.x, ob[Sa + 1] = Yb.y, ob[Sa + 2] = Yb.z, Sa += 3;
                                ...
                                if (bd && Yc && hc) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++)
                                        if (Xb = oa[D], mc = Yc[Xb], void 0 !== mc)
                                            for (sa = 0; 3 > sa; sa++) oc = mc[sa], xc[Tb] = oc.u, xc[Tb +
                                                1] = oc.v, Tb += 2;
                                    D = 0;
                                    for (X = pa.length; D < X; D++)
                                        if (Xb = pa[D], mc = Yc[Xb], void 0 !== mc)
                                            for (sa = 0; 4 > sa; sa++) oc = mc[sa], xc[Tb] = oc.u, xc[Tb + 1] = oc.v, Tb += 2;
                                    0 < Tb && (k.bindBuffer(k.ARRAY_BUFFER, ma.__webglUVBuffer), k.bufferData(k.ARRAY_BUFFER, xc, mb))
                                }
                                if (bd && Zc && hc) {
                                    D = 0;
                                    for (X = oa.length; D < X; D++)
                                        if (Xb = oa[D], nc = Zc[Xb], void 0 !== nc)
                                            for (sa = 0; 3 > sa; sa++) pc = nc[sa], yc[Ub] = pc.u, yc[Ub + 1] = pc.v, Ub += 2;
                                    D = 0;
                                    for (X = pa.length; D < X; D++)
                                        if (Xb = pa[D], nc = Zc[Xb], void 0 !== nc)
                                            for (sa = 0; 4 > sa; sa++) pc = nc[sa], yc[Ub] = pc.u, yc[Ub + 1] = pc.v, Ub += 2;
                                ...
                                if (Xc) {
                                    sa = 0;
                                    for (ic = Xc.length; sa < ic; sa++)
                                        if (w = Xc[sa], w.__original.needsUpdate) {
                                            x = 0;
                                            if (1 === w.size)
                                                if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                                    ...
                                                    D = 0;
                                                    for (X = pa.length; D < X; D++) P = Ta[pa[D]], w.array[x] = w.value[P.a], w.array[x + 1] = w.value[P.b], w.array[x +
                                                ...
                                                if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                                    D = 0;
                                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x +
                                                        6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
                                                    D = 0;
                                                    ...
                                                    D = 0;
                                                    for (X = oa.length; D < X; D++) U = T = S = ta =
                                                        w.value[oa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], x += 9;
                                                    D = 0;
                                                    for (X = pa.length; D < X; D++) ka = U = T = S = ta = w.value[pa[D]], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] = T[ba[0]], w.array[x + 4] = T[ba[1]], w.array[x + 5] = T[ba[2]], w.array[x + 6] = U[ba[0]], w.array[x + 7] = U[ba[1]], w.array[x + 8] = U[ba[2]], w.array[x + 9] = ka[ba[0]], w.array[x + 10] =
                                                    ...
                                                    D = 0;
                                                    for (X = pa.length; D < X; D++) ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S[ba[0]], w.array[x + 1] = S[ba[1]], w.array[x + 2] = S[ba[2]], w.array[x + 3] =
                                                ...
                                                if (void 0 === w.boundTo || "vertices" === w.boundTo) {
                                                    D = 0;
                                                    for (X = oa.length; D < X; D++) P = Ta[oa[D]], S = w.value[P.a], T = w.value[P.b], U = w.value[P.c], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x +
                                                        9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
                                                    D = 0;
                                                ...
                                                D = 0;
                                                for (X = oa.length; D < X; D++) U = T = S = ta =
                                                    w.value[oa[D]], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] = S.z, w.array[x + 3] = S.w, w.array[x + 4] = T.x, w.array[x + 5] = T.y, w.array[x + 6] = T.z, w.array[x + 7] = T.w, w.array[x + 8] = U.x, w.array[x + 9] = U.y, w.array[x + 10] = U.z, w.array[x + 11] = U.w, x += 12;
                                                D = 0;
                                                ...
                                                D = 0;
                                                for (X = pa.length; D < X; D++) ta = w.value[pa[D]], S = ta[0], T = ta[1], U = ta[2], ka = ta[3], w.array[x] = S.x, w.array[x + 1] = S.y, w.array[x + 2] =
                ...
                if (ga.verticesNeedUpdate || ga.colorsNeedUpdate || eb) {
                    ...
                    if (ad) {
                        Rc = 0;
                        for (hd = ad.length; Rc < hd; Rc++)
                            if (va = ad[Rc], va.needsUpdate && (void 0 === va.boundTo || "vertices" === va.boundTo)) {
                                Aa = 0;
                                qc = va.value.length;
                                if (1 === va.size)
                                    for (Qa = 0; Qa < qc; Qa++) va.array[Qa] = va.value[Qa];
                                else if (2 === va.size)
                                    for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y,
                                        Aa += 2;
                                else if (3 === va.size)
                                    if ("c" === va.type)
                                        for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.r, va.array[Aa + 1] = cb.g, va.array[Aa + 2] = cb.b, Aa += 3;
                                    else
                                        for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y, va.array[Aa + 2] = cb.z, Aa += 3;
                                else if (4 === va.size)
                                    for (Qa = 0; Qa < qc; Qa++) cb = va.value[Qa], va.array[Aa] = cb.x, va.array[Aa + 1] = cb.y, va.array[Aa + 2] = cb.z, va.array[Aa + 3] = cb.w, Aa += 4;
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        m = p;
        ic && d && d.useVertexTexture ? l = 1024 : (b = k.getParameter(k.MAX_VERTEX_UNIFORM_VECTORS), b = Math.floor((b -
        ...
        var r;
        a: {
            q = a.fragmentShader;s = a.vertexShader;o = a.uniforms;b = a.attributes;p = a.defines;
            var c = {
                    map: !!a.map,
                    envMap: !!a.envMap,
                    lightMap: !!a.lightMap,
                ...
                t, u, v, d = [];n ? d.push(n) : (d.push(q), d.push(s));
            for (u in p) d.push(u),
            d.push(p[u]);
            for (t in c) d.push(t),
            d.push(c[t]);n = d.join();t = 0;
            for (u = qa.length; t < u; t++)
                if (d = qa[t], d.code === n) {
                    d.usedTimes++;
                    r = d.program;
                    break a
            ...
            u = ["precision " + K + " float;", c.bumpMap || c.normalMap ? "#extension GL_OES_standard_derivatives : enable" : "", u, "#define MAX_DIR_LIGHTS " + c.maxDirLights, "#define MAX_POINT_LIGHTS " + c.maxPointLights, "#define MAX_SPOT_LIGHTS " + c.maxSpotLights, "#define MAX_HEMI_LIGHTS " + c.maxHemiLights, "#define MAX_SHADOWS " + c.maxShadows, c.alphaTest ? "#define ALPHATEST " + c.alphaTest : "", Q.gammaInput ? "#define GAMMA_INPUT" : "", Q.gammaOutput ? "#define GAMMA_OUTPUT" : "", Q.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "",
                ...
                k.VALIDATE_STATUS) + ", gl error [" + k.getError() + "]");k.deleteShader(u);k.deleteShader(t);v.uniforms = {};v.attributes = {};
            ...
            for (y in o) t.push(y);y = t;t = 0;
            for (u = y.length; t < u; t++) d = y[t],
            v.uniforms[d] = k.getUniformLocation(v, d);t = "position normal uv uv2 tangent color skinIndex skinWeight".split(" ");
            for (y = 0; y < c.maxMorphTargets; y++) t.push("morphTarget" +
                y);
            for (y = 0; y < c.maxMorphNormals; y++) t.push("morphNormal" + y);
            for (r in b) t.push(r);r = t;y = 0;
            for (t = r.length; y < t; y++) u = r[y],
            v.attributes[u] = k.getAttribLocation(v, u);v.id = la++;qa.push({
                program: v,
                code: n,
                usedTimes: 1
            });Q.info.memory.programs = qa.length;r = v
        }
        a.program = r;
        ...
        if (a.attributes)
            for (j in a.attributes) void 0 !== r[j] && 0 <= r[j] && k.enableVertexAttribArray(r[j]);
        if (a.morphTargets) {
    ...
    this.setBlending = function(a, b, c, d) {
        a !== Ia && (a === THREE.NoBlending ? k.disable(k.BLEND) : a === THREE.AdditiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.SRC_ALPHA, k.ONE)) : a === THREE.SubtractiveBlending ? (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.ONE_MINUS_SRC_COLOR)) : a === THREE.MultiplyBlending ?
            (k.enable(k.BLEND), k.blendEquation(k.FUNC_ADD), k.blendFunc(k.ZERO, k.SRC_COLOR)) : a === THREE.CustomBlending ? k.enable(k.BLEND) : (k.enable(k.BLEND), k.blendEquationSeparate(k.FUNC_ADD, k.FUNC_ADD), k.blendFuncSeparate(k.SRC_ALPHA, k.ONE_MINUS_SRC_ALPHA, k.ONE, k.ONE_MINUS_SRC_ALPHA)), Ia = a);
    ...
    this.setTexture = function(a, b) {
        if (a.needsUpdate) {
            a.__webglInit || (a.__webglInit = !0, a.__webglTexture =
                k.createTexture(), Q.info.memory.textures++);
    ...
    normalizeUVs: function(a) {
        for (var a = a.faceVertexUvs[0], b = 0, c = a.length; b < c; b++)
            for (var d = a[b], e = 0, f = d.length; e < f; e++)
                if (1 !== d[e].u && (d[e].u -= Math.floor(d[e].u)), 1 !== d[e].v) d[e].v -= Math.floor(d[e].v)
    },
    triangulateQuads: function(a) {
        ...
        for (c = a.faces.length; b < c; b++)
            if (d =
                ...
                n.b = j;
                n.c = l;
                4 === d.vertexColors.length && (m.vertexColors[0] = d.vertexColors[0].clone(), m.vertexColors[1] = d.vertexColors[1].clone(), m.vertexColors[2] = d.vertexColors[3].clone(), n.vertexColors[0] = d.vertexColors[1].clone(), n.vertexColors[1] = d.vertexColors[2].clone(), n.vertexColors[2] =
    ...
    tessellate: function(a, b) {
        ...
        for (d = a.faces.length; c < d; c++)
            if (e = a.faces[c], e instanceof THREE.Face3)
                if (f = e.a, g = e.b, h = e.c, j = a.vertices[f], l = a.vertices[g], m = a.vertices[h], p = j.distanceTo(l), o = l.distanceTo(m), n = j.distanceTo(m), p > b || o > b || n > b) {
                    i = a.vertices.length;
                    u = e.clone();
                    s = e.clone();
                    p >= o &&
                        p >= n ? (j = j.clone(), j.lerpSelf(l, 0.5), u.a = f, u.b = i, u.c = h, s.a = i, s.b = g, s.c = h, 3 === e.vertexNormals.length && (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[1], 0.5), u.vertexNormals[1].copy(f), s.vertexNormals[0].copy(f)), 3 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[1], 0.5), u.vertexColors[1].copy(f), s.vertexColors[0].copy(f)), e = 0) : o >= p && o >= n ? (j = l.clone(), j.lerpSelf(m, 0.5), u.a = f, u.b = g, u.c = i, s.a = i, s.b = h, s.c = f, 3 === e.vertexNormals.length && (f = e.vertexNormals[1].clone(),
                            ...
                            (f = e.vertexNormals[0].clone(), f.lerpSelf(e.vertexNormals[2], 0.5), u.vertexNormals[2].copy(f), s.vertexNormals[0].copy(f)), 3 === e.vertexColors.length && (f = e.vertexColors[0].clone(), f.lerpSelf(e.vertexColors[2], 0.5), u.vertexColors[2].copy(f), s.vertexColors[0].copy(f)), e = 2);
                    z.push(u, s);
                    a.vertices.push(j);
                    f = 0;
                    for (g = a.faceVertexUvs.length; f < g; f++) a.faceVertexUvs[f].length && (j = a.faceVertexUvs[f][c], s = j[0], h = j[1], u = j[2], 0 === e ? (l = s.clone(), l.lerpSelf(h, 0.5), j = [s.clone(), l.clone(), u.clone()], h = [l.clone(), h.clone(),
                        u.clone()
                    ]) : 1 === e ? (l = h.clone(), l.lerpSelf(u, 0.5), j = [s.clone(), h.clone(), l.clone()], h = [l.clone(), u.clone(), s.clone()]) : (l = s.clone(), l.lerpSelf(u, 0.5), j = [s.clone(), h.clone(), l.clone()], h = [l.clone(), h.clone(), u.clone()]), A[f].push(j, h))
                } else {
                    z.push(e);
                    f = 0;
...
THREE.CubeGeometry = function(a, b, c, d, e, f, g, h) {
    function i(a, b, c, g, h, i, l, m) {
        ...
        for (h = 0; h < p; h++)
            for (i = 0; i < o; i++) {
                a = new THREE.Face4(i +
                    u * h + t, i + u * (h + 1) + t, i + 1 + u * (h + 1) + t, i + 1 + u * h + t);
                a.normal.copy(N);
...
THREE.PlaneGeometry = function(a, b, c, d) {
    ...
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, g = c + 1, h = d + 1, i = a / c, j = b / d, l = new THREE.Vector3(0, 0, 1), a = 0; a < h; a++)
        for (b = 0; b < g; b++) this.vertices.push(new THREE.Vector3(b * i - e, -(a * j - f), 0));
    for (a = 0; a < d; a++)
        for (b = 0; b < c; b++) {
...
THREE.ShadowMapPlugin = function() {
    ...
    this.update = function(l, m) {
        ...
        for (p = l.__lights.length; n < p; n++) {
            ...
            if (o.castShadow)
                if (o instanceof THREE.DirectionalLight && o.shadowCascade)
                    for (r = 0; r < o.shadowCascadeCount; r++) {
                        var A;
        ...
        for (p = z.length; n < p; n++) {
            ...
            if (!o.shadowCamera) {
                if (o instanceof THREE.SpotLight) o.shadowCamera = new THREE.PerspectiveCamera(o.shadowCameraFov, o.shadowMapWidth / o.shadowMapHeight, o.shadowCameraNear, o.shadowCameraFar);
            ...
            for (q = s.length; o < q; o++) {
                ...
                t = B.object;
                B.render = false;
                if (t.visible && t.castShadow && (!(t instanceof THREE.Mesh) || !t.frustumCulled ||
                        g.contains(t))) {
    ...
    this.render = function(d, e, p, o) {
        ...
        if (q) {
            ...
            for (var z, A = [], r = 0; r < q; r++) {
                z = d[r];
                if (z.visible && z.opacity !== 0)
                    if (z.useScreenCoordinates) z.z = -z.position.z;
                    else {
    ...
    this.update = function(g, h) {
        ...
        for (j = p.length; i < j; i++) {
            ...
            if (l.render) {
                ...
                m = n.customDepthMaterial ? n.customDepthMaterial : n.geometry.morphTargets.length ?
                    d : c;
